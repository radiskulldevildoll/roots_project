...
# Include 0.0.0.0 for listening on all interfaces during development
...
DJOSER = {
    ...
    'SEND_ACTIVATION_EMAIL': False,  # Set to True in production with email configured
}
...
ROOT_URLCONF = 'roots_project.urls'
...
WSGI_APPLICATION = 'roots_project.wsgi.application'
